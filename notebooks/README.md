...
Analysis notebooks for the IMC spatial proteomics project (Xi et al. NSCLC dataset, Campbell Lab).
All notebooks are written in R Markdown (.Rmd) and intended to be run on the BU SCC under the `camplab` project group.
