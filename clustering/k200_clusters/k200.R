...
cat("Starting k = 200 clustering script\n")
flush.console()
...
## 4. Output path
final_path <- "/restricted/projectnb/camplab/projects/20220504_Suzuki_LN/TumorIMC/analysis/clustering/k200_clusters/harmony_k200_clusters.rds"
